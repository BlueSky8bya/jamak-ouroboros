...
Last Updated: 2026-07-16 (v0.9.46 — API 도구 정책: 맞춤법 검사 관리자 전용화 / 연습 영상은 무-API 도구만 교육)

## 정책 (2026-07-16 확정)
- **검수자(비관리자)**: API 안 쓰는 도구만 — 한자 채우기·타이밍 자동정리·무음 다듬기·나누기/합치기·찾기바꾸기·🙉·되돌리기·확인.
- **관리자(운영자)만**: Claude API 쓰는 도구 — 맞춤법 검사·번역·초안 생성.
