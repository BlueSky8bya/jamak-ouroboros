...
Last Updated: 2026-07-17 (v0.9.77 — 브라우저 재현으로 깻잎(오타 앵커 고정)·Alt+Z(flush 후 캡처 + 포커스 세션 경계) 격파, retime.py 삭제 커밋 누락 정정. v0.9.76 — 투어 말풍선 47개 재작성. 관찰: tourEvent 이중 발화(무해, 감시))
