...
const COURSES: TourCourse[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: (
          <>
            말과 자막이 같으면 <K c="Enter" />. 다 확인하면 영상이 이어져요.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            못 정하겠으면 <b>🙉 잘 안 들림</b>. 나중에 느리게 다시 들려드려요.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="Z" /> (또는 <b>↶</b>) — 방금 한 일이 되돌아가요.
          </>
        ),
        on: "undo",
      },
      ...
      },
      {
        ...
        body: (
          <>
            <b>맞으면 Enter · 틀리면 눌러 고치고 Enter.</b> 이거면 끝까지 가요.
            다른 연습은 <b>🎓 튜토리얼 연습</b> 탭에 있어요.
          </>
        ),
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        target: ".pc-speed",
        title: "느리게 — 0.75×",
        body: <><b>0.75×</b> 를 눌러보세요. 빠른 구간은 느리게 들어요.</>,
        on: "rate",
      },
      {
        target: ".play-controls",
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Ctrl" />+<K c="\\" /> (또는 <b>⏮</b>) — 지금 자막의 처음으로.
          </>
        ),
        on: "replay",
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="R" /> — 이 자막 구간을 계속 반복해 들려줘요.
          </>
        ),
        on: "loop",
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="S" /> — 끄면 들으면서 바로 고칠 수 있어요. 차분히
            볼 땐 다시 켜세요.
          </>
        ),
        on: "pausetype",
      },
      {
        ...
        body: (
          <>
            껐다 켜보세요. 쭉 들을 땐 <b>켜기</b>, 한 자막을 오래 붙잡을 땐{" "}
            <b>끄기</b>.
          </>
        ),
        on: "follow",
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="Shift" />+<K c="↓" /> 또는 <b>이어서 작업하기</b>.
          </>
        ),
        on: "nav-unreviewed",
      },
      {
        ...
        body: (
          <>
            쉬운 건 <K c="Enter" />로 쭉 · 애매하면 🙉로 넘기고 계속 · 반복 오타는
            🔎로 한 번에.
          </>
        ),
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        subject: [16.5, 32.8],
        loopRow: true,
        title: "나누기 — Ctrl+Enter",
        body: (
          <>
            나눌 자리에 <b>커서를 두고</b> <K c="Ctrl" />+<K c="Enter" />.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="Z" /> (또는 <b>↶</b>) — 방금 합친 게 도로 나뉘어요.
          </>
        ),
        on: "undo",
      },
      ...
      },
      {
        ...
        body: (
          <>
            ...
            {/* [WH-CHANGE v0.9.69 | UX | 2026-07-17 | CHG-20260717-103]
                Reason: 나레이션(#10)은 Alt+Delete를 말하는데 이 코스는 실제로 시키지
                  않아 "들었지만 안 해 본" 키로 남았다. 연습6 캡스톤이 실제로 시키므로
                  거기로 연결한다. 연습4는 재렌더 대상이 아니라 말풍선 문구만 고친다
                  (나레이션은 그대로 → 말과 어긋나지 않음).
                Related: 재설계계획 §5, CHANGELOG CHG-20260717-103. */}
            <br />
            <b>지우기는 마지막 6️⃣ 마무리에서 직접 해볼 거예요.</b>
          </>
        ),
      },
    ],
    ...
    steps: [
      {
        target: ".mode-tabs",
        title: "② 타이밍 탭",
        body: <>위의 <b>② 타이밍</b> 을 눌러보세요.</>,
        on: "mode-timing",
      },
      {
        target: ".issue-bar",
        title: "남은 문제만 골라 보기",
        body: <><b>다음 문제 →</b> — 손볼 자막으로 바로 데려다줘요.</>,
      ...
      },
      {
        ...
        body: (
          <>
            <b>말이 시작되는 순간</b> <K c="Alt" />+<K c="[" />. 눈은 영상에 둔 채로.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="\\" /> (또는 <b>⤢</b>) — 실제 말소리 시작~끝에 자동
            으로 맞춰요.
          </>
        ),
        missingHint: "자막을 하나 누르면 영상 밑 시간 줄에 단추가 나와요.",
      ...
      // [WH-CHANGE v0.9.91 | FIX | 2026-07-17 | CHG-20260717-132]
      // Reason: 사용자 지적 — "무음 다듬기 안내창이 실제보다 한 단계 더 빠르게
      //   나왔어". 스텝 순서가 **대본과 반대**였다: 대본은 L11 타임라인 손잡이 →
      //   L12 무음 다듬기인데 스텝은 무음 → 손잡이였고, 체크포인트 배열은 대본
      //   순서(148.2=L11·165.6=L12)라 **무음 말풍선이 L11(타임라인) 대사 위에**
      //   떴다. 바로 위 주석마저 "무음 다듬기 → 타임라인 끌기"라고 거꾸로 적혀
      //   있어 오해를 굳혔다 — 주석이 대본을 확인해 주지 못하면 없느니만 못하다.
      //   대본 순서대로 되돌린다 (체크포인트 값은 그대로 맞다).
      // Related: CHANGELOG CHG-20260717-132.
      // 나레이션 순서(대본 확인): L11 타임라인 끌기 → L12 무음 다듬기
      {
        target: ".timing-strip",
        title: "손잡이 끌기",
        body: (
          <>
            <b>밝은 손잡이를 좌우로 끌어보세요</b>. 미세조정은 이걸로.
          </>
        ),
        on: "edge-drag",
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="M" /> — 조용한 구간에 남은 자막을 한 번에 다듬어요.
          </>
        ),
        on: "tighten",
      },
      {
        ...
        body: (
          <>
            <b>문제만 순회 → <K c="Alt" />+<K c="[" /> / <K c="]" /> / <K c="\\" />로
            손보기.</b> 다 되면 <b>⏱ 타이밍 검수 완료</b>에 체크하세요.
          </>
        ),
      },
    ],
    ...
    steps: [
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="S" /> — 자신 있으면 꺼서 흐르듯이, 벅차면 켜 두고
            차분히. <b>본인 속도가 정답이에요.</b>
          </>
        ),
        on: "pausetype",
      },
      ...
      {
        target: ".row.focused",
        title: "군소리 지우기 — Alt+Delete",
        body: (
          <>
            <b>"음..."</b>, <b>"어."</b>는 자막에 필요 없어요. 그 칸을 누르고{" "}
            <K c="Alt" />+<K c="Delete" />.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            두 칸이 원래 한 문장이에요. 위 칸을 누르고 <K c="Ctrl" />+
            <K c="Shift" />+<K c="Enter" />.
          </>
        ),
        missingHint: "자막 글을 눌러 그 칸을 먼저 고르세요.",
      ...
      },
      {
        ...
        body: (
          <>
            한 칸에 두 문장이 있어요. 문장 사이에 <b>커서를 두고</b>{" "}
            <K c="Ctrl" />+<K c="Enter" />.
          </>
        ),
        missingHint: "자막 글을 눌러 고치기 칸을 먼저 여세요.",
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="↑" />/<K c="↓" /> 칸 이동 · <K c="Shift" />+
            <K c="Tab" /> 3초 뒤로 · <K c="Tab" /> 재생/멈춤.
          </>
        ),
        on: "nav",
      },
      {
        ...
        body: (
          <>
            눌러보세요. 기계가 사전에서 찾아 <b>미리 채워서</b> 보여줘요 — 아직
            반영 전이에요.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            각 줄 <b>▶</b>로 들어보세요. <b>"보시는 분들"</b>의 보시는 布施가
            아니에요 → <b>안 바꿈</b>.
          </>
        ),
      ...
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="P" /> — 시청자가 볼 모습. 확인 후 다시 끄세요.
          </>
        ),
        on: "preview",
      },
      {
        ...
        body: (
          <>
            <K c="Alt" />+<K c="K" /> — 오늘 고친 걸 기계가 외워요. (연습 영상은
            "0개"가 정상)
          </>
        ),
        missingHint: "내용 모드에서 보여요 — ① 내용 확인 탭으로 가보세요.",
      ...
      },
      {
        ...
        body: (
          <>
            <b>속도 정하고 → 맞으면 Enter → 군소리 지우고 → 조각 합치고 → 긴 건
            나누고 → 한자 거르고 → 📚 학습.</b> 이제 진짜 영상을 맡으셔도 돼요.
          </>
        ),
      },
    ],
...
export function Editor({
  ...
  // 모달 미니 영상이 들어앉을 자리. ref가 아니라 **state**로 잡는다 — 맞춤법
  // 모달은 "검사 중..." 화면을 먼저 띄우고 결과가 온 뒤에야 이 자리를 렌더하므로,
  // 자리가 붙는 순간이 훅의 재실행 신호가 되어야 한다 (CHG-20260717-091).
  ...
  const mini = useMiniPlayer(ytVideoId, !!hanjaModal || !!qcModal, miniHost);
    ...
    return (
      <>
        <div className="modal-player">
          ...
          <div ref={setMiniHost} className="modal-player-frame" />
          {previewSec === null && (
  ...
  return (
    ...
    >
      ...
      {qcModal && (
        <div
          className={"srt-modal-back" + (qcModal.mode === "spell" ? " locked" : "")}
          /* 맞춤법 모드는 검수 중 실수 방지 위해 바깥 클릭 무시. 내보내기 점검은
             기존대로 바깥 클릭으로 닫힘(단, 검사 중엔 잠금). */
          onMouseDown={(e) => {
            if (
              qcModal.mode !== "spell" &&
